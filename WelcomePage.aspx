<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WelcomePage.aspx.vb" Inherits="Websites_WelcomePage" %>
                    ...
                    <div class="main-menu">
                        <ul>
                            ...
                            <li><a href="">Menu</a>
                                ...
                                <ul class="sub-menu">
                                    <li><a href="Gujarati.aspx">Gujarati</a></li>
                                    <li><a href="Punjabi.aspx">Punjabi</a></li>
                                    <li><a href="NonVeg.aspx">Non-Veg</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <span class="style-change">of <span class="prime-color">food</span>Plaza</span></h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <div class="welcome-text mt-5 mt-md-0">
                        <h3><span class="style-change">welcome</span> <br>to food plaza</h3>
                        <p class="pt-3">Use our free restaurant ordering software to drive your online sales.

No matter how much your business grows, you'll always benefit from taking unlimited orders with zero fees.

There’s no other GloriaFood alternative that can help you power your business like our free online ordering system for restaurants.</p>
                        <p>Add the "See MENU & Order" & "Table reservation" buttons to your sales optimized website to make the online ordering process easy like cake.

Easy ordering for your customers means higher sales for you.</p>
                    ...
                    <div class="single-food">
                        ...
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="style-change">Rs.800</span>
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5 mt-md-0">
                        ...
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                <h5>topu lasange</h5>
                                <span class="style-change">Rs.500</span>
                            </div>
                            <p class="pt-3">Face together given moveth divided form Of Seasons that fruitful.</p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 align-self-center">
                    ...
                    <div class="deshes-text">
                        ...
                        <span class="style-change">Rs.1000</span>
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center order-1 order-md-2">
                    ...
                    <div class="deshes-text">
                        ...
                        <p class="pt-3">Be. Seed saying our signs beginning face give spirit own beast darkness morning moveth green multiply she'd kind saying one shall, two which darkness have day image god their night. his subdue so you rule can.</p>
                        <span class="style-change">Rs. 590</span>
                        <a href="#" class="template-btn3 mt-3">book a table <span><i class="fa fa-long-arrow-right"></i></span></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="single-widget single-widget2 my-5 my-md-0">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="info-text">
                                    <p>1234 Mehmoorganj chauraha,UP, CA 221001</p>
                                </div>
                            </div>
                            <div class="d-flex">
                                <div class="into-icon">
...
Copyright &copy;<script>                    document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://Food_Plaza.com" target="_blank">Food Palza</a>
