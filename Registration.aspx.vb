...
Partial Class Registration
    ...
    Protected Sub linkSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles linkSubmit.Click
        ...
        'cn = New SqlConnection("Data Source=SQLEXPRES;AttachDbFilename=|DataDirectory|\database.mdf;Integrated Security=True;User Instance=False;Context Connection=False")
        cn.Open()
        Try
